...
const features = [
  ...
  },
  {
    ...
    desc: 'التعامل مع الإجراءات الرسمية بدقة وشفافية تامة، مع ضمان متابعة مستمرة حتى استلام النتيجة النهائية.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    desc: 'تعاون راسخ مع العديد من الجهات الحكومية والخاصة لتوفير أفضل الحلول والخدمات المتكاملة لعملائنا الكرام.',
  },
];
