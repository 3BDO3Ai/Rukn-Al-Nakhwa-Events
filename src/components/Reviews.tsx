...
const reviews = [
  ...
  },
  {
    name: 'Mangar Me',
    rating: 5,
    text: 'سمعة طيبة واحترافية عالية في تقديم الخدمات الإلكترونية، راقين جداً وخدومين. أفضل مكتب خدمات في المنطقة، فخر لنا أن نخلص شغلنا عندهم.',
  },
  {
    name: 'User. Media',
    rating: 5,
    text: 'مكتب احترافي وسريع يعتمد عليه. لديهم حلول لمشاكل إلكترونية لم تُحل إلا من قبلهم، اسم على مسمى "مهمات احترافية" جزاكم الله خيراً.',
  },
  {
    name: 'Mostafa Mahdy',
    rating: 5,
    text: 'من أفضل مكاتب الخدمات، تجربة جميلة جداً والمصداقية والأمانة في التعامل هي أهم ميزة لديهم. سعيد جداً بتعاملي معهم.',
  },
];
