...
const services: Service[] = [
  ...
  },
  {
    ...
    items: [
      'نقل الكفالة للعمالة',
      'رفع طلبات تسوية مخالفات المنشئات',
      'رفع دعاوى التسوية الودية بين العامل وصاحب العمل',
      'إصدار وتجديد وإلغاء الرخص',
      'متابعة الطلبات حتى إنجازها بالكامل',
    ],
  },
  {
    id: 'mudad',
  ...
  },
  {
    ...
    items: [
      'توظيف الموظفين السعوديين بالمنشئات',
      'تعديل أجور الموظفين',
  ...
  },
  {
    ...
    items: [
      'معاينة السيارة وتوثيق حالتها',
      'إعداد عقد البيع الإلكتروني',
      'نقل الملكية إلكترونياً عبر أبشر',
      'تسليم وثائق النقل النهائية',
      'خدمة متكاملة من البداية حتى النهاية',
    ],
  },
  {
    id: 'gov-e-services',
    ...
    items: [
      ...
      'بلدي: إصدار وتجديد الرخص، اللوحات الإعلانية، متابعة الملاحظات',
      'قوى: إدارة العقود، نقل الكفالة، التفويض، إصدار التأشيرات',
      'الزكاة والضريبة والجمارك: تسجيل وإقرارات، تحديث بيانات، معالجة المخالفات',
      'التأمينات الاجتماعية: إضافة وإلغاء مشتركين، تحديث أجور، إصدار شهادات',
      'الغرفة التجارية: توثيق وتصاديق، اشتراكات وتجديد، إصدار عضويات',
    ],
  },
  {
    ...
    items: [
      'تأسيس المنشآت: الاسم التجاري، السجل، الملف الضريبي والتأمينات، العنوان الوطني',
      'خدمات وزارة التجارة: تأسيس شركات، عقود، تراخيص، سجل تجاري',
      'الهوية الرقمية: نفاذ، بريد وطني، إدارة الصلاحيات، تكامل الأنظمة',
      'فتح حساب أفراد: فتح حسابات رقمية عبر الشركاء مع التوثيق والتفعيل الإلكتروني',
      'حماية الأجور - مدد: التفعيل، رفع ملفات الرواتب، معالجة الملاحظات والتقارير',
    ],
  },
  {
    id: 'najiz-real-estate',
    title: 'ناجز والبورصة العقارية والخدمات العدلية',
    ...
    items: [
      'ناجز: وكالات إلكترونية، حصر الإرث، التقاضي الإلكتروني، الترافع والجلسات الافتراضية',
      'البورصة العقارية: تحديث الصكوك، إفراغ عقاري',
      'ضريبة التصرفات العقارية',
      'تسجيل عيني',
      'متابعة التبليغات والإجراءات حتى إتمام المعاملة',
    ],
  },
  {
    ...
    items: [
      ...
      'إصدار وتجديد رخصة بلدي',
    ],
  },
  {
    id: 'utilities-insurance-support',
    title: 'الكهرباء والمياه والتأمين والخدمات المساندة',
    ...
    items: [
      ...
      'التأمين الطبي وتأمين السيارات: إصدار وتجديد وتحديث وإدارة المطالبات',
      'حساب المواطن: تسجيل جديد، تحديث بيانات، إضافة تابعين، متابعة الأهلية',
      'خدمات أخرى: إقامات، التنازل، البلاغات، متابعة المعاملات',
    ],
  },
];
